...
if (isset($_POST['insert'])){
    $nama = $_POST['nama'];
    $gambar = $_POST['gambar'];
	$sql="insert into penyanyi values(NULL, '$nama', '$gambar')";
	$result=mysqli_query($con,$sql);
	exit();
}
if (isset($_POST['edit'])){
...
if (isset($_POST['update'])){
	...
	$nama=$_POST['nama'];
	$gambar=$_POST['gambar'];
	$sql="update penyanyi set nama='$nama', gambar='$gambar' where id=$id";
	$result=mysqli_query($con,$sql);
	exit();
}
...
if(isset($_POST['search'])){
    ...
    $sql="select * from penyanyi where upper(nama) like upper('%$search_query%')";
	$result=mysqli_query($con,$sql);
	while($row=mysqli_fetch_array($result)){
		echo '
		<tr>
			...
			<div class="wrapper">
				<div class="sidebar">
					<ul class="menu">
						...
						<li><a href="admin_penyanyi.php" class="active"><i class="fa-solid fa-microphone-lines"></i>Penyanyi</a></li>
				...
				<section class="view">
					...
					<h3 style="float:left; color: white; height: 0 auto; position: relative; margin-left: 0 auto; margin-right: 0 auto;">Ubah Database Penyanyi</h3>
					<div class="wrap" style="background-color: rgba(96, 96, 96, 0.7); height: 0 auto; margin-left: 30px; margin-right:30px; border-radius: 20px; margin-top:70px; position: relative; padding-left: 20px; padding-right:20px; padding-top: 20px; padding-bottom: 10px;">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label" style="color:white;">Gambar</label>
                            <textarea class="form-control" id="gambar" rows="1"></textarea>
                        </div>
