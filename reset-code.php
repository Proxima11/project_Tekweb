...
<body>
    <div class="container">
        <div class="row">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="spin3" style="fill: white; width: 60px; height: 60px; position: relative; left: 275px; bottom: -200px;"><path d="M499.1 6.3c8.1 6 12.9 15.6 12.9 25.7v72V368c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V147L192 223.8V432c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V200 128c0-14.1 9.3-26.6 22.8-30.7l320-96c9.7-2.9 20.2-1.1 28.3 5z"/></svg>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="spin4" style="fill: white; width: 30px; height: 30px; position: relative; right: 325px; bottom: -150px;"><path d="M499.1 6.3c8.1 6 12.9 15.6 12.9 25.7v72V368c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V147L192 223.8V432c0 44.2-43 80-96 80s-96-35.8-96-80s43-80 96-80c11.2 0 22 1.6 32 4.6V200 128c0-14.1 9.3-26.6 22.8-30.7l320-96c9.7-2.9 20.2-1.1 28.3 5z"/></svg>
        </div>
            <div class="col-md-4 offset-md-4 form">
                <form action="reset-code.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="check-reset-otp" value="Submit" id="submit">
                    </div>
                </form>
            </div>
        </div>
