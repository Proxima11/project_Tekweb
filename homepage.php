...
<head>
	...
	<style>
		...
		.wrapper{width: 1300px; padding: 20px; margin: 0 auto;}
	</style>
</head>
<body>
	<!-- <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px; background: #111111;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-light text-decoration-none">
      <svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"></use></svg>
      <span class="fs-5"><i class="fa fa-home"></i>  Home Music</span>
    </a>
    <hr>
    ...
    <div class="wrapper" style="min-height: 365px;"></div>
    <hr>
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="https://github.com/mdo.png" alt="" width="32" height="32" class="rounded-circle me-2">
        <strong style="color: white;">mdo</strong>
      </a>
      <ul class="dropdown-menu text-small shadow" style="color: white" aria-labelledby="dropdownUser2">
  ...
  <div class="d-flex flex-column flex-shrink-0" style="width: 500px;">
  <div class="card h-100 d-flex">
					      <img src="picture/imgSementara.jpg" class="card-img-top" alt="...">
					      <div class="card-body">
