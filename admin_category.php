...
if (isset($_POST['insert'])){
    $nama = $_POST['nama'];
    $gambar = $_POST['gambar'];
	$sql="insert into category values(NULL, '$nama', '$gambar')";
	$result=mysqli_query($con,$sql);
	exit();
}
if (isset($_POST['edit'])){
...
if (isset($_POST['update'])){
	...
	$nama=$_POST['nama'];
	$gambar=$_POST['gambar'];
	$sql="update category set nama='$nama', gambar='$gambar' where id=$id";
	$result=mysqli_query($con,$sql);
	exit();
}
			...
			<div class="wrapper">
				<div class="sidebar">
					<ul class="menu">
						...
						<li><a href="admin_category.php" class="active"><i class="fa-solid fa-puzzle-piece"></i>Category</a></li>
