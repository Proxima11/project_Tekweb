		...
		<div class="row">
			<div class="col-4">
				...
				<nav class="nav flex-column">
  					<a class="nav-link" href="home.php"><i class="fa-light fa-house"></i>Home</a>
  					<a class="nav-link active" aria-current="page" href="search.php"><i class="fa-regular fa-magnifying-glass"></i>Search</a>
  					<a class="nav-link" href="library.php"><i class="fa-light fa-books"></i>Library</a>
				</nav>
			</div>
			<div class="col-8">
				<div id="account">...</div>
